require(["js/lib/base.js","js/lib/jquery/jquery.js"], function() {
	
	require([
	"js/lib/jquery/jquery-ui.min.js",
	"js/lib/jquery/jquery.cookie.js",
	"js/lib/jquery/jquery.bgiframe.js",
	"js/lib/jquery/jquery.metadata.js",
	"js/lib/jquery/jquery.query.js",
	...
	"js/game.js"], function() {
		...
		var GameBoard = Dispatcher.extend({
			constructor: function(el) {
				...
				if (this.el[0].id == 'gameboard') this.cb = new Capturebox(gameboard);
			},
			height: function(){
		...
		var Die = NumberToken.extend({
			...
			didAppend: function() {
				...
				die.el.css('left', this.opts.left || Random.intBetween(10, boardSize.w - 10));
				die.el.css('top', this.opts.top || Random.intBetween(10, boardSize.h - 10));
